...
CREATE TABLE `GpsData` (
	 ...
	 `Gps_ID` integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `GsmData` (
	 `Trip_ID` integer NOT NULL,
	 `Gsm_ID` integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
	 `TimeStamp` real NOT NULL,
	 `RawData` text NOT NULL,
	 `Command` text,
	 `Value` text,
...
CREATE TABLE `ObdData` (
	 `Trip_ID` integer NOT NULL,
	 `Obd_ID` integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
	 `TimeStamp` real NOT NULL,
	 `RawData` text NOT NULL,
	 `Mode` integer,
	 `PID` integer,
...
CREATE TABLE `WiiData` (
	 `Trip_ID` integer NOT NULL,
	 `Wii_ID` integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
	 `TimeStamp` real NOT NULL,
